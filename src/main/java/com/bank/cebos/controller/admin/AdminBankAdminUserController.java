...
import com.bank.cebos.dto.admin.UpdateBankAdminPasswordRequest;
...
public class AdminBankAdminUserController {
  ...
  @PreAuthorize(SUPER_ADMIN_ONLY)
  public ResponseEntity<BankAdminUserResponse> updatePassword(
      @PathVariable("id") long id, @Valid @RequestBody UpdateBankAdminPasswordRequest body) {
    return ResponseEntity.ok(adminBankAdminUserService.updatePassword(id, body.newPassword()));
  }
}
